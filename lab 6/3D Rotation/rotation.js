...
function draw() {
    ...
    a1 = mat_multi(x_axis, a);
    b1 = mat_multi(x_axis, b);
    c1 = mat_multi(x_axis, c);
    d1 = mat_multi(x_axis, d);
    e1 = mat_multi(x_axis, e);
    f1 = mat_multi(x_axis, f);
    g1 = mat_multi(x_axis, g);
    h1 = mat_multi(x_axis, h);
